...
<span>**Auto-Encoders (AEs)**</span> <span>**Sparse-Coding**</span>
<span>**Self Organized Map (SOM) NN**</span> <span>**Deep
Clustering**</span>
...
The lower hierarchy characterized with a specific and private features,
an instability and constant/permanent change. The higher hierarchy
characterized with a general features, a stability and preservation.
Thus makes it perfect to be implemented in traffic system, where fast
reactions are handled by actuators<span style="color: green">, with a
slow and smooth reaction at the high levels where exists a more
comprehensive point-of-view, which takes all different factors into
account</span>.
